...
public class ClientUserBall{
	...
	public ClientUserBall(int x, int y, Color col, JPanel p) {
		this(x, y, col, p, 25);
	}
	public ClientUserBall(int x, int y, Color col, JPanel p, int hair) {
		pane = p;
		diameter = 40;
		c = col;
		speed = NORMAL_SPEED;
